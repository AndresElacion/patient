<section>
    <header>
        <div class="relative bg-indigo-200 p-4 sm:p-6 rounded-lg overflow-hidden">
            ...
            <a href="#" class="mt-4 inline-flex justify-between items-center rounded-lg shadow-lg bg-blue-500 px-4 py-2 text-xs font-medium text-white hover:bg-blue-700">
